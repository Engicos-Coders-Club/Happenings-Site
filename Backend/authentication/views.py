...
#             if not CustomerModel.objects.filter(email=user_info["email"]).exists():
...
#                 customer_obj.save()
#             customer_obj = CustomerModel.objects.get(email=user_info["email"])
...
#     try:
#         email_recieptants = list(CustomerModel.objects.all().values_list("email", flat=True))
