        ...
        <StyledEngineProvider injectFirst>
          ...
          <Routes>
            ...
            <Route element={isAuthenticated ? <Header /> : null}>
              ...
              <Route
                path="/participants"
                element={isAuthenticated ? <Participants /> : <Login />}
              />
              <Route
                path="/newparticipants"
                element={isAuthenticated ? <NewParticipants /> : <Login />}
              />
              <Route
                path="/tickets"
                element={isAuthenticated ? <Tickets /> : <Login />}
              />
              <Route
                path="/viewparticipants/:id"
                element={isAuthenticated ? <ViewParticipants /> : <Login />}
              />
              {/* ------------------------------> */}
              <Route
                path="*"
