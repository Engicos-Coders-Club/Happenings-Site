...
import { Typography, Card, CardContent, Checkbox, Avatar } from '@material-ui/core';
...
const MyComponent = ({ member, handleCheckboxToggle }) => {
  ...
  return (
    <Card className={classes.card}>
        <CardContent>
        <Avatar alt="Profile Picture" src={member.id_card} className={classes.avatar} />
            <Typography >
            Name: 
            ...
            Present: 
            <Checkbox color="primary" checked={member.attendance}  onClick={() => handleCheckboxToggle(member.id)} />
            </Typography>
        </CardContent>
        </Card>   
  );
