...
TODO: 
1. Validation
2. Disable Register College Button till Payment is Done 
3. Handling Submit for sending information to backend
            ...
            <div className="py-16">
                ...
                <div className="w-[90vw] md:w-[60vw] mx-auto border-orange-700 border-4 mt-10 py-10 border-dotted backdrop-blur-3xl">
                    <form className="flex flex-col gap-y-5 w-3/4 mx-auto py-10">
                        ...
                        <button className={`border-red-500 border w-fit rounded-xl p-3 mx-auto text-white font-bold py-1 bg-black hover:scale-125 hover:bg-red-600 text-sm ${!paymentDone ? 'cursor-not-allowed' : 'cursor-pointer'}`} style={{ 'fontFamily': 'Merriweather' }} type="submit" ><Link to="/event-selection" className={`flex justify-center items-center ${!paymentDone ? 'cursor-not-allowed' : 'cursor-pointer'}`}>Register College <FiArrowUpRight size={20} /></Link></button>
                    </form>
                </div>
            </div>
        </div >
