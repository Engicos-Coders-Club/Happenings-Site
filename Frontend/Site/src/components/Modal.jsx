...
function Modal({event_id,setShowEventModal}) {
    ...
    return (
        ...
        <div id="modal" className="bg-modal-bg bg-cover h-auto md:h-[96%] rounded-lg my-8 w-[78%] sm:w-[68%] md:w-[62%] lg:w-[50%] overflow-y-scroll"style={{ 'fontFamily': 'Merriweather', backgroundColor:"white" }} > 
