...
function Modal() {
  return (
    <div className="absolute z-1 bg-[rgba(0,0,0,0.5)] w-full h-auto flex items-center justify-center">
        <div className="bg-[url(./modalBg.png)]  h-[90%] rounded-lg my-8 w-[78%] sm:w-[68%] md:w-[62%] lg:w-[50%]" >
            ...
            <div className='hidden lg:block'>
                <div className='px-10 my-5 text-base' style={{'display':'grid','grid-template-columns':'60% 36%', 'gap':'4%'}}>
                    <div>
                        ...
                        <p className='border-2 border-black p-2'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Beatae nam eaque voluptas perferendis consequatur rem laboriosam. Temporibus, iusto id. Quidem nemo natus corporis.</p>
                    </div>
                    <img src={Frame} alt="" />
                </div>
            </div>
