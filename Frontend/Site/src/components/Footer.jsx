        ...
        <>
            <div className="bg-black">
                <div className="container mx-auto py-10">
                        ...
                        <div className="mb-6 md:mb-0 px-3 md:px-0">
                            ...
                            <div className="flex items-center mt-4">
                                ...
                                <div className="flex flex-col justify-center">
                                    <h2 className="md:text-lg text-white font-bold uppercase">Sumit komarpant (General Secretary)</h2>
                            ...
                            <div className="flex items-center mt-2">
                                <img src={PersonPic} className="h-24/3 mr-4" />
                                <div className="flex flex-col justify-center">
                                    <h2 className="md:text-lg text-white font-bold uppercase">Sarthak Bandodkar (Cultural Secretary)</h2>
                                    <div className="flex items-center">
                                        <FaWhatsapp className="text-white mr-2" />
                            ...
                            <div className="flex items-center mt-2">
                                <img src={PersonPic} className="h-24/3 mr-4" />
                                <div className="flex flex-col justify-center">
                                    <h2 className="md:text-lg text-white font-bold uppercase">Akash Gauns (Sports Secretary)</h2>
                                    <div className="flex items-center">
                                        <FaWhatsapp className="text-white mr-2" />
                        ...
                        <div className="md:w-1/6">
                            <div className="hidden md:block">
                                ...
                                <ul className="list-none">
                                    <li className="mb-2"><a href="#home" className="text-gray-600 hover:text-blue-500">Home</a></li>
                                    <li className="mb-2"><a href="#events" className="text-gray-600 hover:text-blue-500">Events</a></li>
                                    {/* <li className="mb-2"><a href="#" className="text-gray-600 hover:text-blue-500">Sponsors</a></li> */}
                                    <li className="mb-2"><a href="#schedule" className="text-gray-600 hover:text-blue-500">Schedule</a></li>
                                    <li className="mb-2"><a href="#teams" className="text-gray-600 hover:text-blue-500">Team</a></li>
                    ...
                    <div className="flex justify-between text-sm text-gray-500 mt-6 px-4 md:w-3/5 md:mx-auto">
                        <div>&copy; 2023 Happenings. All Rights Reserved.</div>
                        <div>Powered by <a className="text-gray-500 hover:text-blue-500" href="https://blueskript.com/" target="_blank" rel="noopener noreferrer">Blueskript</a></div>
                    </div>
                </div>
