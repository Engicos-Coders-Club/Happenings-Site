...
function Schedule(props) {
  ...
  return (
    <section id="schedule" className='bg-[#171717ff] schedule opacity-0 h-screen relative md:pl-16  mt-[8400px] sm:mt-[5400px] md:mt-[3700px] lg:mt-[2550px]' style={{'fontFamily':'MangoGrotesque'}}>
