  ...
  return (
    ...
    <div className='my-16'>
        <div className="hidden md:flex items-center justify-around px-10">
            <img src={Line} width={screenSize.width - 400 - props.title.length*7} alt="" />
            <span className="text-lg sm:text-xl md:text-3xl lg:text-4xl">{props.title}</span>
        </div>
        <div className="block md:hidden px-10 my-3">
            <img src={Line} width={screenSize.width - 40} alt="" />
            <p className="text-lg sm:text-2xl text-right">{props.title}</p>
        </div>
