...
function Venue() {
    ...
    return (
        ...
        <div className="flex gap-12 flex-col md:flex-row items-center justify-center relative z-20 py-12" style={{background: 'linear-gradient(269.39deg, #430D0B -0.69%, #010D10 28.48%)'}}>
        <div className="font-satoshi text-center md:text-left mr-5">
            ...
            <div className="grid place-items-center p-4 rounded-xl overflow-hidden">        
                <iframe
                ...
                />
                <div className="py-7">
                    <a href="https://www.google.com/maps/place/Manohar+Parrikar+Indoor+Stadium/@15.261121,73.968611,16z/data=!4m6!3m5!1s0x3bbfb39d51852b17:0xa706b3fadb014ec0!8m2!3d15.2611209!4d73.9686107!16s%2Fg%2F11kw8dk977?hl=en"><button className="border-red-500 border w-fit rounded-xl p-3 mx-auto text-white py-1 bg-black hover:scale-125 hover:bg-orange-600 text-2xl tracking-wider flex items-center justify-center uppercase" style={{ 'fontFamily': 'MangoGrotesque' }} >Navigate<FiArrowUpRight size={20} /></button></a>
