...
function Sponsor() {
  ...
  return (
    ...
    <section
      id="sponsor"
      className="w-full min-h-screen md:pl-16 relative bg-[#171717ff]  text-white overflow-hidden"
    ...
    >
      ...
      <div className="h-auto relative z-1 mx-2">
        <div className="flex flex-wrap xs:justify-between md:justify-between items-center mx-10 my-10">
          <p
            className={
