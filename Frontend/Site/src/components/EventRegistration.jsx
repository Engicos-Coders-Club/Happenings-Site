      ...
      <div className="py-8">
        <div className="flex justify-between w-4/5 mx-auto">
          <div className="flex items-center">
            ...
            />
            <p
              className="px-3 md:px-5 text-xl md:text-3xl"
        ...
        <div className="w-[90vw] md:w-[60vw] mx-auto border-orange-700 border-4 mt-10 py-10 border-dotted backdrop-blur-3xl  rounded-tl-3xl rounded-br-3xl">
          <Formik
            initialValues={{ name: "", phoneNumber: "", email: "", photo: "" }}
          ...
          >
            {({ touched, errors, isSubmitting, values }) => (
              <Form className="flex flex-col gap-y-5 w-3/4 mx-auto my-10">
                ...
                <button
                  className="border-red-500 border w-fit rounded-xl p-3 mx-auto text-white py-1 bg-black hover:scale-125 hover:bg-red-600 text-2xl tracking-wider"
                  style={{ fontFamily: "MangoGrotesque" }}
                >
                  <Link
                  ...
                  >
                    Update Team Member <FiArrowUpRight size={20} />
                  </Link>
                </button>
                <button
                  ...
                  type="submit"
                >
                  Register Team <FiArrowUpRight size={20} />
                </button>
              </Form>
            )}
          </Formik>
