...
function hamBurg(props) {
  let hamClass =
    "w-[95%] relative flex items-center justify-between border-b-0 border-t-2 border-x-2 border-orange-500 hover:bg-white hover:text-black italic";
  let hamClassLast =
    "w-[95%] relative flex items-center justify-between border-b-2 border-t-2 border-x-2 border-orange-500 hover:bg-white hover:text-black  italic";
  ...
  return (
    <div className="h-screen w-full fixed z-[1000] bg-[#171717ff] flex flex-start top-0 gap-0 Ham overflow-hidden left-0">
      <div className=" relative flex flex-wrap text-white text-5xl font-MANGO grow">
        ...
        <div className={hamClass}>
          <div className="pl-9" onClick={ReverseAnimation}>
            <Link to="/tickets">BUY PASSES</Link>
          </div>
          <div className="pr-9">
            <BsBoxArrowUpRight size={30} color="#171717ff" />
          </div>
